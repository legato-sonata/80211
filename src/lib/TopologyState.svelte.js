const DEFAULT_EXAMPLE_STATE = {
  nodes: [
    ...
    { id: 'n3', type: 'pos', label: 'Register 1', ip: '192.168.1.101', subnet: '255.255.255.0', gateway: '192.168.1.1', status: 'online', details: { serial: '00:1A:2B:3C:4D:5E', location: 'Front Counter' }, x: -250, y: 150 },
    { id: 'n4', type: 'pos', label: 'Register 2', ip: '192.168.1.102', subnet: '255.255.255.0', gateway: '192.168.1.1', status: 'warning', details: { serial: '00:1A:2B:3C:4D:5F', location: 'Front Counter', error: 'High Latency detected' }, x: -50, y: 150 },
    { id: 'n5', type: 'ap', label: 'Ceiling AP (Floor)', ip: '192.168.1.10', subnet: '255.255.255.0', gateway: '192.168.1.1', status: 'offline', details: { serial: '00:1A:2B:3C:4D:60', ssid: 'Store_Guest' }, x: 150, y: 150 },
    { id: 'n6', type: 'camera', label: 'CCTV Front Door', ip: '192.168.1.20', subnet: '255.255.255.0', gateway: '192.168.1.1', status: 'online', details: { serial: '00:1A:2B:3C:4D:61', resolution: '1080p' }, x: 150, y: -200 },
    { id: 'n7', type: 'printer', label: 'Kitchen Printer', ip: '192.168.1.50', subnet: '255.255.255.0', gateway: '192.168.1.1', status: 'warning', details: { serial: '00:1A:2B:3C:4D:62', ink: 'Low' }, x: -250, y: -50 }
  ],
  links: [
